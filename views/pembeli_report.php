        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Penbeli (Pasien)</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">ID Pasien</th><th>Nama</th><th>Alamat</th><th>No. Telepon</th><th>Keluhan</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									...
									<td><?= $data['keluhan'] ?> </td>
                                    <td>
                                        <a href="report/laporan_pembelipersatu.php?id=<?= $data['id_pasien'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/laporan_pembeli.php" target="_blank" class="btn btn-info btn-sm">
