        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Resep Pasien</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">ID Resep</th><th>ID Pasien</th><th>Nama Pasien</th><th>Alamat Pasien</th><th>Keluhan</th><th>Nama Obat</th><th>Jumlah Obat</th><th>Aturan Pakai</th><th>Harga</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['harga'] ?> </td>
                                    <td>
                                        <a href="report/laporan_reseppersatu.php?id=<?= $data['id_resep'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/laporan_resep.php" target="_blank" class="btn btn-info btn-sm">
